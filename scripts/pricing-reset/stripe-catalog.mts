...
const P: PriceDef[] = [
  ...
  { lookupKey: 'front_desk_basic_149m', sku: 'front-desk-basic', productSku: 'front-desk-basic', productName: 'Front Desk Basic', line: 'front-desk', description: '100 calls a month of 24/7 answering and booking.', amount: 14900, interval: 'month', subDescription: MONTH_TO_MONTH },
  { lookupKey: 'front_desk_plus_249m', sku: 'front-desk-plus', productSku: 'front-desk-plus', productName: 'Front Desk Plus', line: 'front-desk', description: '250 calls a month with calendar and CRM sync.', amount: 24900, interval: 'month', subDescription: MONTH_TO_MONTH },
  { lookupKey: 'front_desk_pro_399m', sku: 'front-desk-pro', productSku: 'front-desk-pro', productName: 'Front Desk Pro', line: 'front-desk', description: '500 calls a month, web chat, multi-line, priority changes.', amount: 39900, interval: 'month', subDescription: MONTH_TO_MONTH },
  ...
  { lookupKey: 'front_desk_basic_1490y', sku: 'front-desk-basic-annual', productSku: 'front-desk-basic', productName: 'Front Desk Basic', line: 'front-desk', description: '100 calls a month of 24/7 answering and booking.', amount: 149000, interval: 'year', subDescription: ANNUAL },
  { lookupKey: 'front_desk_plus_2490y', sku: 'front-desk-plus-annual', productSku: 'front-desk-plus', productName: 'Front Desk Plus', line: 'front-desk', description: '250 calls a month with calendar and CRM sync.', amount: 249000, interval: 'year', subDescription: ANNUAL },
  { lookupKey: 'front_desk_pro_3990y', sku: 'front-desk-pro-annual', productSku: 'front-desk-pro', productName: 'Front Desk Pro', line: 'front-desk', description: '500 calls a month, web chat, multi-line, priority changes.', amount: 399000, interval: 'year', subDescription: ANNUAL },
]
