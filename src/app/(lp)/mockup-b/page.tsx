...
// Visual mockup B — Heritage warm palette + sans-only Manrope display +
// alternating eyebrows (hero / audit / pricing keep, stats / testimonial /
// final-CTA drop). Same content as A; only the eyebrow rhythm differs.
// Re-wrote 2026-05-27 after dev review rejected the dark Boreal palette.

export const metadata: Metadata = {
  title: 'Mockup B · Sans + alternating eyebrows',
...
export default function MockupBPage() {
  return (
    <div style={{ fontFamily: 'var(--font-sans)' }}>
      <Banner label="Mockup B · Heritage palette + sans-only + alternating eyebrows (hero/audit/pricing only)" />
      ...
      <section style={{ backgroundColor: 'var(--color-bg)' }}>
        <div className="mx-auto max-w-[1280px] px-6 sm:px-10 py-20">
          <h2 className="text-[clamp(1.5rem,2.5vw,2rem)] font-bold leading-[1.15] tracking-[-0.015em] max-w-xl text-[var(--color-fg)]">
      ...
      <section style={{ backgroundColor: 'var(--color-bg)' }}>
        <div className="mx-auto max-w-[1280px] px-6 sm:px-10 py-20">
          <figure className="max-w-3xl">
            <blockquote className="text-[clamp(1.5rem,2.2vw,2rem)] leading-[1.35] font-medium tracking-[-0.01em] text-[var(--color-fg)]">
            ...
            <figcaption className="mt-6 text-[14px] text-[var(--color-fg-muted)]">
      ...
      {/* FINAL CTA — NO eyebrow, parallax bg */}
