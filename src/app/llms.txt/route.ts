...
- [AI Front Desk](${SITE_URL}/ai-front-desk): AI phone answering that books appointments and texts callers back. Setup $299 one-time, live in 5 days. Then Basic $149/mo (100 calls), Plus $249/mo (250 calls), or Pro $399/mo (500 calls, plus web chat on your website). Overage $1 per call on all plans; calls under 15 seconds and calls your team answers do not count.
