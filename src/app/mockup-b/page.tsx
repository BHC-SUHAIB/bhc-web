...
// Visual mockup B — palette + sans-only display + alternating eyebrows.
// Same hand-rolled JSX as mockup-a, but the secondary sections (stats,
// testimonial, final CTA) drop their small uppercase eyebrows so the page
// rhythm reads less like "every section announced the same way." The
// announcement-bearing sections (hero, audit, pricing) keep theirs.

export const metadata: Metadata = {
  title: 'Mockup B · Boreal + sans + alternating eyebrows',
...
export default function MockupBPage() {
  return (
    <div style={themeStyle}>
      <Banner label="Mockup B · Boreal palette + sans-only + alternating eyebrows (hero/audit/pricing only)" />
      ...
      <section className="relative isolate overflow-hidden" style={{ backgroundColor: 'var(--bg)' }}>
        ...
        <div className="mx-auto max-w-[1280px] px-6 sm:px-10 py-20 sm:py-28 md:py-36">
          <p className={eyebrow} style={{ color: 'var(--brass)' }}>Houston Heights · One-person studio</p>
      ...
      <section className="border-t" style={{ borderColor: 'var(--border)' }}>
        <div className="mx-auto max-w-[1280px] px-6 sm:px-10 py-16">
          <h2 className="text-[clamp(1.5rem,2.5vw,2rem)] font-bold leading-[1.15] tracking-[-0.015em] max-w-xl" style={{ color: 'var(--fg)' }}>
            Three things you get on every project.
          </h2>
      ...
      {/* AUDIT TOOL — KEEPS eyebrow */}
      <section className="border-t" style={{ borderColor: 'var(--border)' }}>
        <div className="mx-auto max-w-[840px] px-6 sm:px-10 py-16">
          <p className={eyebrow} style={{ color: 'var(--brass)' }}>PageSpeed audit</p>
      ...
      {/* TESTIMONIAL — NO eyebrow */}
      <section className="border-t" style={{ borderColor: 'var(--border)' }}>
        <div className="mx-auto max-w-[1280px] px-6 sm:px-10 py-16">
          <figure className="max-w-3xl">
            <blockquote className="text-[clamp(1.5rem,2.2vw,2rem)] leading-[1.35] font-medium tracking-[-0.01em]" style={{ color: 'var(--fg)' }}>
            ...
            <figcaption className="mt-6 text-[14px]" style={{ color: 'var(--fg-muted)' }}>
      ...
      {/* PRICING — KEEPS eyebrow */}
      <section className="border-t" style={{ borderColor: 'var(--border)' }}>
        <div className="mx-auto max-w-[1280px] px-6 sm:px-10 py-16">
          <p className={eyebrow} style={{ color: 'var(--brass)' }}>The offer</p>
