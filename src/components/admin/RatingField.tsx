...
// Interactive star rating field. Stores its value as a string ("0",
// "0.5", "1" … "5") in the Testimonials.rating column. Hover the left
// or right half of any star to preview, click to commit, click the ×
// to clear. Matches the public renderer's brass styling so what you
// see in admin is what visitors see on the site.
