...
export const TIERS: Record<string, TierInfo> = {
  ...
  'front-desk-basic': {
    ...
    projectType: 'ai-front-desk',
    summary: '100 calls a month of 24/7 answering and booking, $149 a month.',
    value: 149,
  },
  'front-desk-plus': {
    ...
    projectType: 'ai-front-desk',
    summary: '250 calls a month with calendar and CRM sync, $249 a month.',
    value: 249,
  },
  'front-desk-pro': {
    slug: 'front-desk-pro',
    ...
    projectType: 'ai-front-desk',
    summary: '500 calls a month, multi-line, priority changes, $399 a month.',
    value: 399,
  },
  'automation-sprint': {
