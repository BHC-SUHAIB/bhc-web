...
export const TIER_BLOCKS = {
  ...
  frontDeskBasic: {
    ...
    features: f(['100 calls a month', '24/7 answering and booking', 'Text confirmations to callers', 'Call summaries to you', 'Monthly transcript review']),
    cta: ask('front-desk-basic', 'Get started'),
  },
  frontDeskPlus: {
    name: 'Front Desk Plus', price: '$249/mo', highlighted: true,
    footnote: 'Overage $1 per call. Premium voice add-on $49 per month.',
    features: f(['250 calls a month', 'Everything in Basic', 'Calendar and CRM sync', 'Two lines or locations']),
...
export const FAQ_FRONT_DESK = faqItems([
  ...
  ['What counts as a call and what happens if I go over?', 'Each call the AI answers counts once, however long it runs. Calls under 15 seconds and calls your team picks up do not count. Plans include 100, 250, or 500 calls a month, and overage is $1 per call, billed monthly.'],
...
export const aiFrontDeskPage = (opts: { webChatMediaId?: string | number } = {}) => ({
  ...
  layout: [
    ...
    },
    {
      ...
      anchorId: 'plans',
      tiers: [
        { ...TIER_BLOCKS.frontDeskSetup, footnote: 'Overage $1 per call. Premium voice add-on $49 per month.' },
